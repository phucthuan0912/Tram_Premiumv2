    ...
    return (
        <div className="space-y-6 py-4 sm:space-y-8 sm:py-6">
            <section className="section-shell px-5 py-6 sm:px-8 sm:py-8">
                ...
                <div className="grid items-center gap-8 lg:grid-cols-[0.8fr_1fr] max-w-4xl mx-auto">
                    <div className="overflow-hidden rounded-[28px] border border-white/70 bg-white/70 p-3 shadow-[0_22px_45px_rgba(15,23,42,0.1)] flex justify-center items-center bg-slate-50">
                        <img
                            className="w-full max-w-[320px] rounded-[22px] object-contain"
                            src={assets.qr_zalo}
                            alt="Zalo QR Code"
                        />
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="rounded-[24px] border border-[var(--border)] bg-white p-6 shadow-sm">
                            ...
                            <p className="mt-4 whitespace-pre-line text-sm leading-7 text-slate-700 font-medium sm:text-base">
                                {t.storeAddress}
                            </p>
                        ...
                        <div className="rounded-[24px] border border-[var(--border)] bg-white p-6 shadow-sm">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noreferrer"
                                className="mt-5 inline-block rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold uppercase tracking-[0.16em] text-white shadow-[0_18px_36px_rgba(15,23,42,0.16)] hover:-translate-y-0.5 hover:bg-slate-800 transition-all duration-300"
                            >
                                {t.careersCta}
                            </a>
                        </div>
            ...
            <section className="space-y-5">
                ...
                <div className="grid gap-4 md:grid-cols-2 max-w-4xl mx-auto">
                    <div className="section-shell p-6 text-center sm:p-7 transition-transform hover:-translate-y-1 hover:shadow-md">

...
const copy = {
    vi: {
        accountEyebrow: 'Tài khoản Premium Station',
        heroTitle: 'Trạm xăng hiện đại.',
        heroDescription:
            'Đăng nhập hoặc tạo tài khoản để theo dõi giao dịch, quản lý thẻ thành viên và thanh toán nhanh chóng tại mọi trạm Premium.',
        heroPoint1: 'Đồng bộ giao dịch theo thời gian thực',
        heroPoint2: 'Thanh toán không tiếp xúc',
        heroPoint3: 'Tích điểm và ưu đãi độc quyền',
        signUpTitle: 'Đăng ký',
        loginTitle: 'Đăng nhập',
        signUpDescription: 'Tạo tài khoản mới để trải nghiệm dịch vụ cao cấp.',
        loginDescription: 'Đăng nhập để tiếp tục sử dụng dịch vụ và ưu đãi của bạn.',
        name: 'Họ và tên',
        email: 'Email',
        password: 'Mật khẩu',
    ...
    en: {
        accountEyebrow: 'Premium Station Account',
        heroTitle: 'Modern gas station.',
        heroDescription:
            'Sign in or create an account to track transactions, manage membership cards and pay quickly at all Premium stations.',
        heroPoint1: 'Real-time transaction sync',
        heroPoint2: 'Contactless payment',
        heroPoint3: 'Exclusive points and rewards',
        signUpTitle: 'Register',
        loginTitle: 'Login',
        signUpDescription: 'Create a new account to experience premium services.',
        loginDescription: 'Login to continue using your services and benefits.',
        name: 'Name',
        email: 'Email',
        password: 'Password',

    ...
    const copy = useMemo(() => {
        if (language === 'vi') {
            return {
                ...
                compactDesc:
                    'Để lại email để nhận tư vấn và báo giá các tài khoản premium AI, Design, Streaming. Chúng tôi sẽ gửi thông tin liên hệ Zalo trực tiếp về email của bạn.',
                featuredBadge: 'Ưu đãi đặc biệt cho khách hàng mới',
                featuredTitle: 'Nhận tư vấn miễn phí trước khi hết thời gian.',
                featuredDesc:
                    'Đăng ký ngay để nhận thông tin liên hệ qua Zalo. Chúng tôi sẽ tư vấn và báo giá các tài khoản premium phù hợp với nhu cầu của bạn.',
                subscriberTitle: 'Đăng ký nhận tư vấn miễn phí',
                subscriberDesc:
                    'Để lại email để nhận tư vấn và báo giá các tài khoản premium AI, Design, Streaming. Thông tin liên hệ Zalo sẽ được gửi trực tiếp về email của bạn.',

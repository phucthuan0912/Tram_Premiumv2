...
const Login = ({ setToken }) => {
  ...
  const adminCopy = {
    vi: {
      ...
      titleMain: 'Trạm Premium',
      titleAccent: 'Quản lý chuyên nghiệp',
      description: 'Nền tảng quản lý trạm xăng hiện đại với công nghệ tiên tiến, tối ưu vận hành và kinh doanh.',
      chips: [
        'Quản lý kho nhiên liệu thông minh',
    ...
    en: {
      ...
      titleMain: 'Premium Station',
      titleAccent: 'Professional Management',
      description: 'Modern gas station management platform with advanced technology, optimizing operations and business.',
      chips: [
  ...
  const copy = adminCopy[locale] || adminCopy.vi
        ...
        <div className="fv-login-card">
          ...
          <div className="fv-panel-left">
            ...
            <div className="fv-left-content">
              ...
              <div className="fv-hero">
                <div className="fv-hero-eyebrow">{copy.eyebrow}</div>
          ...
          <div className="fv-panel-right">
            ...
            <div className="fv-footer">
              © {new Date().getFullYear()} Premium Station. All rights reserved.
            </div>
          </div>
